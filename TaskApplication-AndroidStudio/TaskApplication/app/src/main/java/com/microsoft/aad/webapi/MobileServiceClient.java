 ...
 */
package com.microsoft.aad.webapi;
...
public class MobileServiceClient {
	...
	private static String APPKEY_NOT_REQUIRED = "NotNeeded";
	/**
	 ...
	 * 
	 * @param appUrl
	 * 				Target mobile service url
	 * @param context
	 * 				The Context where the MobileServiceClient is created. It is used to launch interactive activity if needed
	 * @throws java.net.MalformedURLException
	 */
	public MobileServiceClient(String appUrl, Context context)
			throws MalformedURLException {
		this(new URL(appUrl), APPKEY_NOT_REQUIRED, context);
	}
	 ...
	 */
	public <E> void invokeApi(String apiName, Class<E> clazz,
	 ...
	 *            The callback to invoke after the API execution
	 */
	public <E> void invokeApi(String apiName, Object body, Class<E> clazz,
			ApiOperationCallback<E> callback) {
	 ...
	 *            The callback to invoke after the API execution
	 */
	public <E> void invokeApi(String apiName, String httpMethod,
	 ...
	 *            The callback to invoke after the API execution
	 */
	public <E> void invokeApi(String apiName, Object body, String httpMethod,
			List<Pair<String, String>> parameters, final Class<E> clazz,
			final ApiOperationCallback<E> callback) {
		if (clazz == null) {
			if (callback != null) {
				callback.onCompleted(null, new IllegalArgumentException(
						"clazz cannot be null"), null);
			}
			return;
		}
		...
		invokeApi(apiName, json, httpMethod, parameters,
	...
	public void invokeApi(String apiName, JsonElement body, String httpMethod,
		...
		if (body != null) {
			requestHeaders.add(new Pair<String, String>(HTTP.CONTENT_TYPE,
					MobileServiceConnection.JSON_CONTENTTYPE));
		}
